"""
Implementing this here until uvicorn (in conjunction with gunicorn)
supports the standard Forwarded HTTP header (RFC 7239):
https://github.com/encode/uvicorn/issues/2237
"""
